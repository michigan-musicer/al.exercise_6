...
// ANSWER: depends on the system, but for modern systems 
...
// ANSWER: free is called twice, so the second call attempts to
...
// ANSWER: the address at x_ptr is used after it is freed from
...
// ANSWER: malloc is too small by one byte. "hello" is 6
